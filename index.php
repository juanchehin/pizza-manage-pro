...
<body class="hold-transition login-page" style="background-image: url('assets/img/pizza_fondo.jpg'); background-size: cover;">
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>PizzaManagerPro</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <div class="input-group mb-3">
        ...
        <div class="row">
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-success btn-block">Acceso</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
